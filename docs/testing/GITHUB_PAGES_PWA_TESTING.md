...
4. Check console: fallback registration logs failed paths before success
...
- ✅ Console may show an initial 404 on the first attempted path, followed by an info log that a fallback path registered
- ✅ sw.js file loads without errors after fallback
